    ...
    <section className='wrapper'>
      ...
      <div>
        <p>
          ...
          total bill & any other taxes, if any introduced newly payable to the
          Govt. of India from time to time.
        </p>
        <p>
          <span>2 .</span> Kms & Time will be calculated from Shed to Shed.
        </p>
        <p>
          <span>3 .</span> Inter State Permit charges, car parking, Tollgate
          Charge “Extra “Out of station coverage 250km Shed to Shed.
        </p>
        <p>
          <span>4 .</span> Usage more than 4 hours from the above given
